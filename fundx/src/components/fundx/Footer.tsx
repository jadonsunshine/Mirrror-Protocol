        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-24">
          ...
          <div className="flex flex-col items-start space-y-8 w-full lg:w-auto">
            ...
            <nav className="flex flex-wrap gap-6 md:gap-8 text-sm font-medium text-slate-500">
              <a href="#" className="hover:text-indigo-600 transition-colors">For Builders</a>
              <a href="#" className="hover:text-indigo-600 transition-colors">For Funders</a>
              ...
              <a href="#" className="hover:text-indigo-600 transition-colors">SDK Docs</a>
            ...
            <div className="flex items-center gap-5 text-slate-900">
              ...
              {/* X (Twitter) */}
              <a href="#" className="hover:text-indigo-600 transition-colors hover:scale-110">
